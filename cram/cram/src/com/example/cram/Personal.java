...
TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener{
	...
	private HashMap<String, TabInfo> mHashMapTabInfo = new HashMap<String, Personal.TabInfo>();
	View v;
	...
	private void initViewPager() {
		...
		fragments.add(Fragment.instantiate(getActivity(), PersonalLogin.class.getName())); //加入登入頁面至Tabhost
		fragments.add(Fragment.instantiate(getActivity(), PersonalRegister.class.getName())); //加入註冊頁面至Tabhost
	...
	private void initTabHost(Bundle args) {
		...
		// Create Child Tab2
		Personal.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("subtab2").setIndicator(createTabView(mContext, "註冊")),
				(tabInfo = new TabInfo("Tab2", PersonalRegister.class, args)));
		this.mHashMapTabInfo.put(tabInfo.tag, tabInfo);
